...
@Component({
  selector: 'app-balance-transfer-gold-loan-lead',
  templateUrl: './balance-transfer-gold-loan-lead.component.html',
  styleUrls: ['./balance-transfer-gold-loan-lead.component.scss'],
  providers: [UserSettingService , BalanceTransferGoldLoanLeadsService]
})
export class BalanceTransferGoldLoanLeadComponent implements OnInit {
