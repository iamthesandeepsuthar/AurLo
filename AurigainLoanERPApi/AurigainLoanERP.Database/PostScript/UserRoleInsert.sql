...
INSERT [dbo].[UserRole] ( [Name], [ParentId], [IsActive], [IsDelete], [CreatedOn], [ModifiedOn], [CreatedBy], [ModifiedBy]) VALUES ( N'Web Admin Operator', NULL , 1, 0, CAST(N'2021-10-13T02:43:28.403' AS DateTime), NULL, 0, NULL)
